...
- Name: Authentication >> should show error with invalid credentials
- Location: F:\Proejktowe\GodLikeCrmERP\Crm\tests\playwright\auth\login.spec.ts:14:7
...
Call log:
  - waiting for getByLabel(/password/i)
    ...
    at F:\Proejktowe\GodLikeCrmERP\Crm\tests\playwright\auth\login.spec.ts:19:40
```
...
- main:
  ...
  - text: Adres email
  - textbox "Adres email": invalid@example.com
  - text: Hasło
