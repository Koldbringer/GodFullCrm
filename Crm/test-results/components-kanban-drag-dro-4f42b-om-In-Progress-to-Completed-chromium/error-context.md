...
- Name: Kanban Drag and Drop >> should drag a card from In Progress to Completed
- Location: F:\Proejktowe\GodLikeCrmERP\Crm\tests\playwright\components\kanban-drag-drop.spec.ts:38:7
