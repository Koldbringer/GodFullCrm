...
import { DataTable } from '@/components/ui/data-table/data-table'; // Zakładam, że istnieje komponent DataTable
...
export function UserRolesSettings() {
  ...
  // Definicja kolumn dla tabeli ról (przykładowa) - PRZENIESIONE DO WEWNĄTRZ KOMPONENTU
