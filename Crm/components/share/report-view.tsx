...
export function ReportView({ link }: ReportViewProps) {
  return (
    <div className="container py-10">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {link.description || 'Raport'}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <p className="text-muted-foreground">
              Ta funkcjonalność jest w trakcie implementacji. Wkrótce będzie dostępny pełny podgląd raportu.
            </p>
