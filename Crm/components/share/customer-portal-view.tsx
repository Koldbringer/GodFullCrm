...
export function CustomerPortalView({ link }: CustomerPortalViewProps) {
  return (
    <div className="container py-10">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {link.description || 'Portal klienta'}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <p className="text-muted-foreground">
              Ta funkcjonalność jest w trakcie implementacji. Wkrótce będzie dostępny pełny portal klienta.
            </p>
