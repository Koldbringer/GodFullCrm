...
import { MapPin, Filter, Building2, User, Wrench, Layers, MapIcon, WifiOff } from "lucide-react"
...
import { OfflineMapClient } from "./offline-client"

export const metadata: Metadata = {
  title: "Mapa Offline - HVAC CRM ERP",
  description: "Wizualizacja lokalizacji klientów i zleceń na mapie w trybie offline",
}
...
export default async function OfflineMapPage({
  searchParams
}: {
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <div className="flex-1 space-y-4 p-8 pt-6">
        <div className="flex items-center justify-between space-y-2">
          <div>
            <h2 className="text-3xl font-bold tracking-tight">Mapa Offline</h2>
            <p className="text-muted-foreground">
              Wizualizacja lokalizacji klientów i zleceń na mapie w trybie offline
            </p>
          </div>
        ...
        <OfflineMapClient initialLocations={mapLocations} />
      </div>
    </div>
  )
}