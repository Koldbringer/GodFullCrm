...
const mockEvents = [
  ...
  },
  {
    ...
    date: new Date(2024, 4, 15, 15, 0),
    endDate: new Date(2024, 4, 15, 16, 30),
    customer: "Anna Nowak",
    address: "ul. Testowa 45, Warszawa",
    type: "maintenance",
    status: "scheduled"
  },
  {
    ...
    date: new Date(2024, 4, 16, 9, 0),
    endDate: new Date(2024, 4, 16, 11, 0),
    customer: "Firma XYZ",
  ...
  {
    id: "evt4",
    title: "Oględziny przed montażem",
    date: new Date(2024, 4, 17, 12, 0),
    endDate: new Date(2024, 4, 17, 13, 0),
