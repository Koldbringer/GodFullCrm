    ...
    <div className="flex min-h-screen flex-col bg-background">
        ...
        <div className="flex h-14 items-center px-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-xs text-muted-foreground">{technician.role}</div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-3 gap-2">
          <Card className="border shadow-sm">
            <CardContent className="p-3 flex flex-col items-center justify-center">
              <div className="text-xl font-bold">{technician.completedToday}</div>
              <div className="text-xs text-muted-foreground">Ukończone</div>
            </CardContent>
          </Card>
          <Card className="border shadow-sm">
            <CardContent className="p-3 flex flex-col items-center justify-center">
              <div className="text-xl font-bold">{technician.pendingToday}</div>
              <div className="text-xs text-muted-foreground">Oczekujące</div>
            </CardContent>
          </Card>
          <Card className="border shadow-sm">
            <CardContent className="p-3 flex flex-col items-center justify-center">
              <div className="text-xl font-bold">{technician.efficiency}%</div>
            ...
            <Card className="border shadow-sm">
              ...
              <CardContent className="p-4 pt-2 space-y-4">
                <div className="space-y-2">
                  ...
                  <select id="service-type" className="w-full h-9 rounded-md border border-input bg-background px-3 py-1 text-sm shadow-sm">
            ...
            <Card className="border shadow-sm">
              ...
              <CardContent className="p-4 pt-0 space-y-4">
                <div className="space-y-2">
                  ...
                  <select id="diagnostic-type" className="w-full h-9 rounded-md border border-input bg-background px-3 py-1 text-sm shadow-sm">
      ...
      <div className="sticky bottom-0 border-t bg-background p-2">
        <div className="grid grid-cols-4 gap-1">
          <Button variant="ghost" className="flex flex-col h-16 rounded-md">
